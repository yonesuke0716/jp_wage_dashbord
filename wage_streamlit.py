...
df_jp_category = pd.read_csv(
    "./csv_data/雇用_医療福祉_一人当たり賃金_全国_大分類.csv", encoding="shift_jis"
)
df_pref_ind = pd.read_csv(
    "./csv_data/雇用_医療福祉_一人当たり賃金_都道府県_全産業.csv", encoding="shift_jis"
)
...
view = pdk.ViewState(longitude=139.691648, latitude=35.689185, zoom=4, pitch=40.5)
...
st.header("■集計年別の一人当たりの賃金（万円）の推移")
